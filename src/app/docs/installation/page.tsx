  ...
  return (
    <div className="max-w-3xl">
      ...
      <section className="prose dark:prose-invert prose-slate max-w-none">
        ...
        <h2 className="text-2xl font-semibold mt-8 mb-4 text-gray-900 dark:text-white">Prerequisites</h2>
        ...
        <pre className="bg-gray-100 dark:bg-gray-800 p-4 rounded-lg my-4">
          <code className="text-gray-800 dark:text-gray-200">npx shadcn@latest init</code>
        </pre>
        <p className="text-gray-700 dark:text-gray-300 mb-4">
          Or use the new <code className="bg-gray-100 dark:bg-gray-800 px-2 py-1 rounded">create</code> command for an interactive setup with more customization options:
        </p>
        <pre className="bg-gray-100 dark:bg-gray-800 p-4 rounded-lg my-4">
          <code className="text-gray-800 dark:text-gray-200">npx shadcn@latest create</code>
        </pre>
        <p className="text-gray-700 dark:text-gray-300 mb-4">
        ...
        <h3 className="text-xl font-semibold mt-6 mb-3 text-gray-900 dark:text-white">Visual Style Presets</h3>
        <p className="text-gray-700 dark:text-gray-300 mb-4">
        ...
        <h2 className="text-2xl font-semibold mt-8 mb-4 text-gray-900 dark:text-white">Add W3-Kit Components</h2>
        <p className="text-gray-700 dark:text-gray-300 mb-4">
        ...
        <h2 className="text-2xl font-semibold mt-8 mb-4 text-gray-900 dark:text-white">Useful CLI Commands</h2>
        <p className="text-gray-700 dark:text-gray-300 mb-4">
        ...
        <div className="space-y-4">
          <div>
            ...
            <pre className="bg-gray-100 dark:bg-gray-800 p-4 rounded-lg">
              <code className="text-gray-800 dark:text-gray-200">npx shadcn@latest view button</code>
            </pre>
          </div>
          <div>
            <p className="text-gray-700 dark:text-gray-300 mb-2">
            ...
            <pre className="bg-gray-100 dark:bg-gray-800 p-4 rounded-lg">
              <code className="text-gray-800 dark:text-gray-200">npx shadcn@latest search</code>
            </pre>
          </div>
          <div>
            <p className="text-gray-700 dark:text-gray-300 mb-2">
            ...
            <pre className="bg-gray-100 dark:bg-gray-800 p-4 rounded-lg">
              <code className="text-gray-800 dark:text-gray-200">npx shadcn@latest list</code>
            </pre>
          </div>
          <div>
            <p className="text-gray-700 dark:text-gray-300 mb-2">
            ...
            <pre className="bg-gray-100 dark:bg-gray-800 p-4 rounded-lg">
              <code className="text-gray-800 dark:text-gray-200">npx shadcn@latest diff</code>
            </pre>
          </div>
        </div>

        <h2 className="text-2xl font-semibold mt-8 mb-4 text-gray-900 dark:text-white">Migration Guide</h2>
        <p className="text-gray-700 dark:text-gray-300 mb-4">
          If you have an existing project using the old <code className="bg-gray-100 dark:bg-gray-800 px-2 py-1 rounded">@radix-ui/react-*</code> packages, you can migrate to the new unified <code className="bg-gray-100 dark:bg-gray-800 px-2 py-1 rounded">radix-ui</code> package:
        </p>
        <pre className="bg-gray-100 dark:bg-gray-800 p-4 rounded-lg my-4">
          <code className="text-gray-800 dark:text-gray-200">npx shadcn@latest migrate radix</code>
        </pre>
        <p className="text-gray-700 dark:text-gray-300 mb-4">
          This command will:
        </p>
        <ul className="list-disc pl-6 mb-6 text-gray-700 dark:text-gray-300">
          <li>Replace all <code className="bg-gray-100 dark:bg-gray-800 px-2 py-1 rounded">@radix-ui/react-*</code> imports with <code className="bg-gray-100 dark:bg-gray-800 px-2 py-1 rounded">radix-ui</code></li>
          <li>Update your UI components automatically</li>
          <li>Install the new <code className="bg-gray-100 dark:bg-gray-800 px-2 py-1 rounded">radix-ui</code> package as a dependency</li>
        </ul>

        <h2 className="text-2xl font-semibold mt-8 mb-4 text-gray-900 dark:text-white">Example Usage</h2>
        <p className="text-gray-700 dark:text-gray-300 mb-4">
