...
import { FooterLinkGroup } from "../../shared/ui/footer-bits/footer-link-group";
  ...
  return (
    <AppFooter>
      <div className="mx-auto grid max-w-[1200px] gap-10 px-6 py-12 sm:grid-cols-2 md:grid-cols-6 md:px-8 lg:px-16">
        ...
        <FooterLinkGroup title="Getting Started" links={gettingStartedLinks} />
        <FooterLinkGroup title="Guides" links={guidesLinks} />
        <FooterLinkGroup title="Recipes" links={recipesLinks} />
