  ...
  return (
    <div style={{ ...previewCard, maxWidth: 400, width: "100%", margin: "0 auto" }}>
        ...
        <div style={{ borderRadius: 12, overflow: "hidden", border: "1px solid var(--w3-border-subtle)" }}>
          ...
          <div style={{ padding: "14px 16px", display: "flex", flexDirection: "column", gap: 8 }}>
            ...
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
              <span style={{ fontSize: 15, fontWeight: 600, color: "var(--w3-gray-900)", fontFamily: monoFont }}>68.5 ETH</span>
              <span style={{ fontSize: 13, color: "var(--w3-gray-600)", fontFamily: monoFont }}>0xd8dA...6045</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div style={{ padding: "12px 20px", borderTop: "1px solid var(--w3-border-subtle)", textAlign: "center" }}>
        <span style={{ fontSize: 13, color: "var(--w3-gray-500)" }}>BAYC Collection</span>
      </div>
    </div>
  );
}
