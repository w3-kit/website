    ...
    <section className="grid grid-cols-2 items-end gap-20 border-b border-w3-border-subtle px-20 pb-12 pt-[88px]">
      ...
      <div>
        ...
        <h1 className="m-0 text-[88px] font-medium leading-[0.92] tracking-[-0.05em] text-w3-gray-900">
          ...
          developer
          <br />
          <span className="font-serif-display italic text-w3-accent">toolkit,</span> assembled.
        </h1>
      ...
      <div className="flex flex-col gap-4">
        <p className="m-0 max-w-[440px] text-[17px] leading-relaxed text-w3-gray-800">
          Fifty-plus typed components. Fourteen chains, eighteen tokens, one CLI. Ship your dApp
          this afternoon, not next quarter.
        </p>
